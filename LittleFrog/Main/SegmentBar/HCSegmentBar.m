...
@property (nonatomic, strong) HCSegmentBarConfig *config;

@end

@implementation HCSegmentBar



#pragma mark - 接口
+ (instancetype)segmentBarWithFrame: (CGRect)frame {
    HCSegmentBar *segmentBar = [[HCSegmentBar alloc] initWithFrame:frame];
...
- (HCSegmentBarConfig *)config {
    if (!_config) {
        _config = [HCSegmentBarConfig defaultConfig];
    }
    return _config;
}
